...
from utils import get_device, load_saved_model, save_model, train_some_times, show_image
...
class MyDataset(Dataset):
    def __init__(self, base_df, device):
        ...
        self.trans = transforms.Compose([
            ...
            transforms.RandomResizedCrop((IMG_WIDTH, IMG_HEIGHT), scale=(.9, 1), ratio=(1, 1), antialias=False),
